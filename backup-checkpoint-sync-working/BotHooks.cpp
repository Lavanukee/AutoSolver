...
class $modify(BotBGLHook, GJBaseGameLayer) {
    ...
    void updateCamera(float dt) {
        // Guard against firing for the SHADOW PlayLayer (its construction
        // or a manual shadow tick). The bot's runSearch operates on real;
        // running it on shadow would either crash or recurse.
